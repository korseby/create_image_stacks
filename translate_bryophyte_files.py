...
def rename_files(dest_files):
	...
	new_names = [re.sub(" Antheridiums ", " antheridium ", i) for i in new_names]
	...
	new_names = [re.sub(" Archegoniums ", " archegonium ", i) for i in new_names]
	new_names = [re.sub(" Assimilationslamellen ", " assimilation lamellae ", i) for i in new_names]
	...
	new_names = [re.sub(" des ", " of the ", i) for i in new_names]
	new_names = [re.sub(" Elateren ", " elaters ", i) for i in new_names]
	new_names = [re.sub(" Elatere ", " elater ", i) for i in new_names]
	new_names = [re.sub(" Epidermis ", " epidermis ", i) for i in new_names]
	new_names = [re.sub(" Epidermisendzellen ", " epidermis end cells ", i) for i in new_names]
	new_names = [re.sub(" Epidermisendzelle ", " epidermis end cell ", i) for i in new_names]
	...
	new_names = [re.sub(" Habitat ", " habitat ", i) for i in new_names]
	new_names = [re.sub(" Habitat", " habitat", i) for i in new_names]
	new_names = [re.sub(" Habitus ", " stature ", i) for i in new_names]
	new_names = [re.sub(" Habitus", " stature", i) for i in new_names]
	new_names = [re.sub(" Halskanalzellen ", " neck canal cells ", i) for i in new_names]
	new_names = [re.sub(" Halskanalzelles ", " neck canal cells ", i) for i in new_names]
	...
	new_names = [re.sub(" Oelkoerper ", " oil bodies ", i) for i in new_names]
	new_names = [re.sub(" Oelzellen ", " oil cells ", i) for i in new_names]
	...
	new_names = [re.sub(" Poren ", " pores ", i) for i in new_names]
	new_names = [re.sub(" Pore ", " pores ", i) for i in new_names]
	...
	new_names = [re.sub(" Standort ", " location ", i) for i in new_names]
	new_names = [re.sub(" Standort", " location", i) for i in new_names]
